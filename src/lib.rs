...
#[derive(Debug)]
pub struct CardanoNodeProcessor {
    verbose: bool,
    processed_count: usize,
}

impl CardanoNodeProcessor {
...
pub fn run(verbose: bool, input: Option<String>, output: Option<String>) -> Result<()> {
    ...
    info!("Starting CardanoNode processing");
    
    let mut processor = CardanoNodeProcessor::new(verbose);
...
mod tests {
    ...
    fn test_processor_creation() {
        let processor = CardanoNodeProcessor::new(true);
    ...
    fn test_data_processing() {
        let mut processor = CardanoNodeProcessor::new(false);
